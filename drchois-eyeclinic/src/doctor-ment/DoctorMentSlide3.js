        ...
        <section className="doctorBackgroundContainer">
            ...
            <div className="content_wrapper">
                ...
                <div className="wording">
                    <div className="wording_content">
                        <span>23년 무사고</span>
                        <span>
                            임상 1만시간 이상, 3만 임상증례를 넘는 시력교정술
                            경험
                        </span>
                        <span>
                            최첨단 장비와 51가지 정밀검사로 당신의 눈에 최적화된
                        </span>
                ...
                <div className="doctor-background">
                    <div className="col1">
                        <DoctorBackgroundStructure
                            boundary={[0, backGroundAsset.length - 9]}
                        />
                    </div>
                    <div className="col2">
                        <DoctorBackgroundStructure
                            boundary={[
                                backGroundAsset.length - 8,
                                backGroundAsset.length - 1,
                            ]}
                        />
                    </div>
                </div>
