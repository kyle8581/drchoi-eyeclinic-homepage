...
function MobileSignature(){
    return(
        <Wrapper>
            <img className="bg" src="/doctor-ment/mobile_sitting.png" alt="bg"/>
            <Title>
            ...
            <Paragraph>
                ...
                <span>최승일</span>
                <img  className="signature" src="/doctor-ment/signature.png" alt="signature"/>
